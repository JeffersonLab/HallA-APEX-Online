...
//      faSetDAC(faSlot(islot), 3150, 0xffff);
     // faSetDAC(faSlot(islot), 325, 0);
      ...
      // faSetProcMode(faSlot(islot), 10, 85, 40, 5, 60, 1, 4,250,2);
	    ...
	    if(islot==4||islot==5||islot==6||islot==7)faSetProcMode(faSlot(islot), FADC_MODE_SCIFI, FADC_LATENCY_SCIFI, FADC_WD_SCIFI, FADC_NSB_SCIFI, FADC_NSA_SCIFI, 1, 15,357,FADC_NSAT); // SciFi
            }
          else
            {
	    ...
	    if(islot==4||islot==5||islot==6||islot==7)faSetProcMode(faSlot(islot), FADC_MODE_SCIFI, FADC_LATENCY_SCIFI, FADC_WD_SCIFI, FADC_NSB_SCIFI, FADC_NSA_SCIFI, 15, 15,357,1);   // SciFi
