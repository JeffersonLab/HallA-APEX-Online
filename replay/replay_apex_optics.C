...
void replay_apex_optics(Int_t runnumber=0,Int_t numevents=0,Int_t fstEvt=0,Bool_t QuietRun = kFALSE, Bool_t OnlineReplay =kFALSE, Bool_t bPlots = kFALSE, Bool_t left = kTRUE, Bool_t right = kTRUE, Bool_t autoreplay = kFALSE, Bool_t skim = kFALSE, Bool_t coinc_cut = kFALSE){
  ...
  TString rootname;
  if(OnlineReplay){
    rootname = "%s/apex_online_%d_9_3_2020.root";}
  else {
    rootname = "%s/apex_%d_9_3_2020.root"; //
    if (skim)
