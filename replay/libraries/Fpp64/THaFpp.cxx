...
// 	};
	...
	//---------
	// B.Schmookler (August, 2016):
	// Z coord. changed to 1.53 m and rotation angle changed to 0 deg.
	// Real Values for Z can be found in the database. If you want to
	// use the values in the database, consult Longwu's "gmp_fpp" class
	Float_t kx,ky,kz;
	Float_t angle;
	...
	ky = 0;
	kz = 1.53; // meters
	angle = 0.; //degrees (relative to transport coor. sys.)
