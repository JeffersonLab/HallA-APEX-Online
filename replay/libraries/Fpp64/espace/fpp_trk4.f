      subroutine trk4(debug,itrcode,nhit,hit,ntrack,track,
     &                xsave,zsave,dxsave,plsave)
c
c
c      include 'option.h'
c
...
c      write(*,*) itrcode
c      write(*,*) (nhit(i),i=1,25)
c      write(*,*) ntrack
c      write(*,*) (xsave(i),i=1,6)
c      write(*,*) (zsave(i),i=1,6)
c      write(*,*) (dxsave(i),i=1,6)
c      write(*,*) (plsave(i),i=1,6)
c      print*, 'debug = ', debug
...
c     start analysis
      ...
      do i=1,6         
         ...
         do j=1,35
            ztra(nchm,i,j)=0.0d0
            xtra(nchm,i,j)=0.0d0
            dxtra(nchm,i,j)=0.0d0
            dxfit(nchm,i,j)=0.0d0
            utra(nchm,i,j)=0
            pltra(nchm,i,j)=0
         enddo
         enddo
