...
// New conetest variables
        ...
        Double_t xpoly1[6] = {-110.0,-87.0,110.0,110.0,87.0,-110.0};
        Double_t ypoly1[6] = {33.0,55.0,55.0,-33.0,-55.0,-55.0};
        Int_t nsides1 = 6;

        Double_t xpoly2[6] = {-110.0,-87.0,110.0,110.0,87.0,-110.0};
        Double_t ypoly2[6] = {33.0,55.0,55.0,-33.0,-55.0,-55.0};
        Int_t nsides2 = 6;
...
// zclose and sclose between front and rer FPP
...
// decided to put a 10cm "border" around the outside, to be conservative
	...
	if((coneteste!=conetest)&&fDebug>0) {
      ...
      zback=fZfpp[5];
      r1x3 = (zback-zclose)*(tphia + (ttheta-tphia)/(1.0+ttheta*tphia));
      r2x3 = (zback-zclose)*((ttheta+tphia)/(1.0-ttheta*tphia) - tphia);
      r1y3 = (zback-zclose)*(tthetaa +(ttheta-tthetaa)/(1.0+ttheta*tthetaa));
      r2y3 = (zback-zclose)*((ttheta+tthetaa)/(1.0-ttheta*tthetaa)- tthetaa);

      zback=fZfpp[11];
      r1x4 = (zback-zclose)*(tphia + (ttheta-tphia)/(1.0+ttheta*tphia));
      r2x4 = (zback-zclose)*((ttheta+tphia)/(1.0-ttheta*tphia) - tphia);
      r1y4 = (zback-zclose)*(tthetaa +(ttheta-tthetaa)/(1.0+ttheta*tthetaa));
      r2y4 = (zback-zclose)*((ttheta+tthetaa)/(1.0-ttheta*tthetaa)- tthetaa);
