...
const int TritiumDetMap::kDetMapSize;
...
void TritiumDetMap::Module::SetModel( UInt_t m )
{
  model = m & kModelMask;
...
//_____________________________________________________________________________
void TritiumDetMap::Module::SetResolution( Double_t res )
{
  resolution = res;
}

//_____________________________________________________________________________
TritiumDetMap::TritiumDetMap() : fNmodules(0), fMap(0), fMaplength(0)
{
  // Default constructor. Creates an empty detector map.
}

//_____________________________________________________________________________
TritiumDetMap::TritiumDetMap( const TritiumDetMap& rhs )
{
  // Copy constructor
...
//_____________________________________________________________________________
TritiumDetMap& TritiumDetMap::operator=( const TritiumDetMap& rhs )
{
  // TritiumDetMap assignment operator
...
//_____________________________________________________________________________
Int_t TritiumDetMap::AddModule( UShort_t crate, UShort_t slot, 
...
//_____________________________________________________________________________
TritiumDetMap::Module* TritiumDetMap::Find( UShort_t crate, UShort_t slot,
				    UShort_t chan )
{
...
//_____________________________________________________________________________
Int_t TritiumDetMap::Fill( const vector<Int_t>& values, UInt_t flags )
{
...
//_____________________________________________________________________________
Int_t TritiumDetMap::GetTotNumChan() const
{
...
//_____________________________________________________________________________
void TritiumDetMap::GetMinMaxChan( Int_t& min, Int_t& max, ECountMode mode ) const
{
...
//_____________________________________________________________________________
void TritiumDetMap::Print( Option_t* ) const
{
...
static int compare_modules( const void* p1, const void* p2 )
{
  ...
  const TritiumDetMap::Module* lhs = static_cast<const TritiumDetMap::Module*>(p1);
  const TritiumDetMap::Module* rhs = static_cast<const TritiumDetMap::Module*>(p2);
