...
Tri_ElossCorrection::Tri_ElossCorrection( const char* name, 
...
//_____________________________________________________________________________
Tri_ElossCorrection::~Tri_ElossCorrection()
{
	// Destructor
...
//_____________________________________________________________________________
void Tri_ElossCorrection::Clear( Option_t* opt )
{
...
//_____________________________________________________________________________
THaAnalysisObject::EStatus Tri_ElossCorrection::Init( const TDatime& run_time )
{
...
//_____________________________________________________________________________
Int_t Tri_ElossCorrection::DefineVariables( EMode mode )
{
...
//_____________________________________________________________________________
Int_t Tri_ElossCorrection::ReadRunDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
void Tri_ElossCorrection::SetInputModule( const char* name ) 
{
...
//_____________________________________________________________________________
void Tri_ElossCorrection::SetMass( Double_t m ) 
{
...
//_____________________________________________________________________________
void Tri_ElossCorrection::SetTestMode( Bool_t enable, Double_t eloss_value ) 
{
...
//_____________________________________________________________________________
void Tri_ElossCorrection::SetMedium( Double_t Z, Double_t A,
		Double_t density ) 
{
...
//_____________________________________________________________________________
void Tri_ElossCorrection::SetPathlength( Double_t pathlength ) 
{
...
//_____________________________________________________________________________
void Tri_ElossCorrection::SetPathlength( const char* vertex_module,
...
//
//_____________________________________________________________________________
Double_t Tri_ElossCorrection::ElossElectron( Double_t beta, Double_t z_med,
...
//_____________________________________________________________________________
Double_t Tri_ElossCorrection:: ElossHadron( Int_t Z_hadron, Double_t beta, 
...
Double_t Tri_ElossCorrection::ExEnerg( Double_t z_med, Double_t d_med )
{
	...
	//---- Beryllium (Be)
	else if( TMath::Abs( z_med-4.00 ) < 0.1 )
		EXEN = 63.7;
	...
	//---- Table overflow
		...
		cout << "Implement Tri_ElossCorrection::ExEnerg routine for proper use." 
			<< endl << endl;
		EXEN = 0.0;
	}
...
//_____________________________________________________________________________
void Tri_ElossCorrection::HaDensi( Double_t z_med, Double_t d_med,
		Double_t& X0, Double_t& X1, Double_t& M )
{
	...
	//---- Table overflow
		...
		cout << "z_med = " << z_med << " d_med = " << d_med << endl;
		cout << "Implement Tri_ElossCorrection::HaDensi routine for proper use."
			<< endl << endl;
		X0 =  0.;
		X1 =  0.;
		M  =  0.;
