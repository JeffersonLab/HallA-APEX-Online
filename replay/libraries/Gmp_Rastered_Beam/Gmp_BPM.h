...
class Gmp_BPM : public THaBeamDet {

public:
  Gmp_BPM( const char* name, const char* description = "",
		   THaApparatus* a = NULL );
  virtual ~Gmp_BPM();
...
protected:
  ...
  Gmp_BPM& operator=( const Gmp_BPM& ) { return *this; }
  ...
  ClassDef(Gmp_BPM,0)   // Generic BPM class
};
