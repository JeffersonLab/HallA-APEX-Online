...
//_____________________________________________________________________________
void TriVDCeff::VDCvar_t::Reset( Option_t* )
{
...
//_____________________________________________________________________________
TriVDCeff::TriVDCeff( const char* name, const char* description )
  : THaPhysicsModule(name,description), fNevt(0)
{
  // TriVDCeff module constructor
...
//_____________________________________________________________________________
void TriVDCeff::Reset( Option_t* opt )
{
...
//_____________________________________________________________________________
Int_t TriVDCeff::Begin( THaRunBase* )
{
  // Start of analysis
...
//_____________________________________________________________________________
Int_t TriVDCeff::End( THaRunBase* )
{
  // End of analysis
...
//_____________________________________________________________________________
THaAnalysisObject::EStatus TriVDCeff::Init( const TDatime& run_time )
{
  // Initialize TriVDCeff physics module
...
//_____________________________________________________________________________
Int_t TriVDCeff::Process( const THaEvData& /*evdata*/ )
{
...
//_____________________________________________________________________________
Int_t TriVDCeff::ReadDatabase( const TDatime& date )
{
