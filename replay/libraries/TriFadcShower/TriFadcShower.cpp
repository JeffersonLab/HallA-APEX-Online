...
// TriFadcShower                                                              //
//                                                                           //
// Shower counter class for Fadc, adopted from ThaShower class               //
// Shujie Li, 08.2018                                                         //
// describing a generic segmented shower detector                             //
// (preshower or shower).                                                    //
...
TriFadcShower::TriFadcShower( const char* name, const char* description,
...
//_____________________________________________________________________________
Int_t TriFadcShower::ReadDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t TriFadcShower::DefineVariables( EMode mode )
{
...
//_____________________________________________________________________________
void TriFadcShower::Clear( Option_t* opt )
{
  // Clear event data
...
//_____________________________________________________________________________
Int_t TriFadcShower::Decode( const THaEvData& evdata )
{
  ...
  for( Int_t i = 0; i < nmodules; i++ ) {
	...
	if( fDebug>0 ) {
      ...
      Int_t  data = evdata.GetData(kPulseIntegral,d->crate,d->slot,chan,0);//fadc
...
//_____________________________________________________________________________
Int_t TriFadcShower::CoarseProcess( TClonesArray& tracks )
{
...
//_____________________________________________________________________________
Int_t TriFadcShower::FineProcess( TClonesArray& tracks )
{
