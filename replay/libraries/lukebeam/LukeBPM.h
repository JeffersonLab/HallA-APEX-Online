...
class LukeBPM : public THaBeamDet {

public:
  LukeBPM( const char* name, const char* description = "",
		   THaApparatus* a = NULL );
  virtual ~LukeBPM();
...
protected:
  ...
  //  LukeBPM() {}
  //  LukeBPM( const LukeBPM& ) {}
  LukeBPM& operator=( const LukeBPM& ) { return *this; }
  ...
  ClassDef(LukeBPM,0)   // Generic BPM class
};
