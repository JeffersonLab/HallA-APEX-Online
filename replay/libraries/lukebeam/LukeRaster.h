#ifndef ROOT_LukeRaster
#define ROOT_LukeRaster
...
class LukeRaster : public THaBeamDet {

public:
  LukeRaster( const char* name, const char* description = "",
		   THaApparatus* a = NULL );
  virtual ~LukeRaster();
...
protected:
  ...
  //  LukeRaster() {}
  //  LukeRaster( const LukeRaster& ) {}
  LukeRaster& operator=( const LukeRaster& ) { return *this; }
  ...
  ClassDef(LukeRaster,0)   // Generic Raster class
};
