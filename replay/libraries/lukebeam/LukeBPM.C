...
LukeBPM::LukeBPM( const char* name, const char* description,
...
//                         inconsistent data
//
Int_t LukeBPM::ReadDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t LukeBPM::DefineVariables( EMode mode )
{
...
//_____________________________________________________________________________
Int_t LukeBPM::Decode( const THaEvData& evdata )
{
