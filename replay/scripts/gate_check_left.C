...
void gate_check_left(Int_t flag, Char_t *drawoption){
  ...
  if(flag==1){
    ...
    TH2F *ht1 = new TH2F("ht1","All Cherenkov PMTs: Amplitude vs. Time",1000,1500,2500,500,0,500);
    ...
    tree->Draw("L.cer.a_p:L.cer.t>>ht1","",drawoption);
  }
  ...
  if(flag==2){
    ...
    tree->Draw("L.s2.la_p:L.s2.lt>>ht2","",drawoption);
  ...
  if(flag==3){
    ...
    tree->Draw("L.s2.ra_p:L.s2.rt>>ht3","",drawoption);
  ...
  if(flag==4){
    ...
    tree->Draw("L.s0.ra_p:L.s0.rt>>ht4","",drawoption);
  ...
  if(flag==5){
    ...
    tree->Draw("L.s0.la_p:L.s0.lt>>ht5","",drawoption);
    
  }

  if(flag==6){
    
    TH2F *ht6 = new TH2F("ht6","Calorimeter Hardware Sum: Amplitude vs. Time",1000,1000,2000,2000,1000,5000);
  ...
  if(flag==7){
    ...
    TH2F *ht7 = new TH2F("ht7","Gas Cherenkov Hardware Sum: Amplitude vs. Time (All Hits)",500,1000,2000,1000,200,4200);
