void check_electrons_test(Int_t run=0){
  ...
  if (run==0) { // Left HRS
    ...
    // 1 pass runs
    t->Add("~/gmp/replay/Rootfiles/left_gmp_13903*.root");
...
//    t->Add("~/gmp/replay/Rootfiles/right_gmp_2295[1,2]*");
    ...
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2318[^6]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2319[^67]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2320[0,1]*.root");
    ...
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2346[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2347[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2348[^7]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2349[^5]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2350[^0]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2351[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2352[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2353[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2354[^4]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2355[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2356[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2357[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2358[^3]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2359[^04]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2360[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2361[0-9]*.root");
    t->Add("~/gmp/replay/Rootfiles/right_gmp_2362[1-4]*.root");

    // GMp parasitic runs (4 pass II)
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2365[4-9]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2366[^5]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2367[^1]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2368[^4]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2369[0-9]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2370[^79]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2371[2-9]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2372[3-6,8,9]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2373[^9]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2374[0,1]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2375[5-9]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2376[1-3,9]*.root");
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_2377[0-6]*.root");

    // 1-pass runs
    //t->Add("~/gmp/replay/Rootfiles/right_gmp_22775*.root");
  }
  ...
  h2->GetYaxis()->SetTitle("Fractional momentum");
  h2->GetYaxis()->CenterTitle();
  h2->GetXaxis()->SetTitle("In-plane angle");
  h2->GetXaxis()->CenterTitle();
