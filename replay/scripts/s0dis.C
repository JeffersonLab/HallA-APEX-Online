...
//Ranit Das, Feb 2019
void s0dis(Int_t flag, TString drawoption){
  ...
  TTree *tree = (TTree*)gDirectory->Get("T");
    ...
    TH1F *hay1 = new TH1F("hay1","L-arm S0-X Distribution",150,-1.5,1.5);
    hay1->GetXaxis()->SetTitle("S0-X");hay1->GetXaxis()->CenterTitle();
   ...
   TH1F *hay2 = new TH1F("hay2","L-arm S0-Y Distribution",150,-0.4,0.4);
    hay2->GetXaxis()->SetTitle("S0-Y");hay2->GetXaxis()->CenterTitle();
    // ht1->GetYaxis()->SetTitle("Amplitude [ADC Channel]");ht1->GetYaxis()->CenterTitle();
    // ht1->SetMarkerStyle(3);ht1->SetMarkerSize(0.75);
    // &&(R.ps.e+R.sh.e)/(R.gold.p*1000)>0.7 &&(L.prl1.e+L.prl2.e)/(L.gold.p*1000)>0.7&
    tree->Draw("L.s0.try>>hay2");
  ...
  TH2F *hay3 = new TH2F("hay3","L-arm S0 y vs. x",150,-1.5,1.5,150,-0.4,0.4);
  hay3->GetXaxis()->SetTitle("S0-X");hay3->GetXaxis()->CenterTitle();
  hay3->GetYaxis()->SetTitle("S0-Y");hay3->GetYaxis()->CenterTitle();
  
  tree->Draw("L.s0.try:L.s0.trx>>hay3","","colz");
}

if(flag==4){
    
    TH1F *hay4 = new TH1F("hay4","R-arm S0-X Distribution",150,-1.5,1.5);
    hay4->GetXaxis()->SetTitle("S0-X");hay4->GetXaxis()->CenterTitle();
    // ht1->GetYaxis()->SetTitle("Amplitude [ADC Channel]");ht1->GetYaxis()->CenterTitle();
    // ht1->SetMarkerStyle(3);ht1->SetMarkerSize(0.75);
    // &&(R.ps.e+R.sh.e)/(R.gold.p*1000)>0.7 &&(L.prl1.e+L.prl2.e)/(L.gold.p*1000)>0.7&
   ...
   TH1F *hay5 = new TH1F("hay5","R-arm S0-Y Distribution",150,-0.4,0.4);
  ...
  TH2F *hay6 = new TH2F("hay6","R-arm S0 y vs. x",150,-1.5,1.5,150,-0.4,0.4);
