...
void gate_check_right(Int_t flag, TString drawoption){
 ...
 gStyle->SetOptStat(0);
  ...
  if(flag==1){
    ...
    TH2F *ht1 = new TH2F("ht1","All Cherenkov PMTs: Amplitude vs. Time",1000,1200,2200,1000,0,1000);
  ...
  if(flag==2){
    ...
    TH2F *ht2 = new TH2F("ht2","All Left S2 PMTs: Amplitude vs. Time",1000,1500,2500,200,-50,500);
  ...
  if(flag==3){
    ...
    TH2F *ht3 = new TH2F("ht3","All Right S2 PMTs: Amplitude vs. Time",1000,1500,2500,200,-50,500);
  ...
  if(flag==4){
    ...
    TH2F *ht4 = new TH2F("ht4","S0-Top(B): Amplitude vs. Time",500,1500,2500,2000,0,4000);
  ...
  if(flag==5){
    ...
    TH2F *ht5 = new TH2F("ht5","S0-Bottom(A): Amplitude vs. Time",500,1500,2500,2000,0,4000);
  ...
  if(flag==7){
    ...
    TH2F *ht7 = new TH2F("ht7","Gas Cherenkov Hardware Sum: Amplitude vs. Time (All Hits)",500,1200,2200,1100,-100,10000);
