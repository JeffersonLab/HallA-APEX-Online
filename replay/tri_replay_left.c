...
void tri_replay_left(Int_t runnumber=0,Int_t all=50000,Int_t fstEvt=0,Bool_t QuietRun = kFALSE){
 ...
 // char* def_dir="/home/jbane/tritium/triton/HallA-Online-Tritium/replay/";
  char* RNAME="%s/tritium_%d.root";
	...
	char* ODEF="/home/jbane/tritium/triton/HallA-Online-Tritium/replay/LHRS.odef";
	char* CUTS="/home/jbane/tritium/triton/HallA-Online-Tritium/replay/LHRS.cuts";
//    ODEF=Form("%sLHRS.odef",def_dir);
 //   CUTS=Form("%sLHRS.cuts",def_dir);
    ...
    gHaApps->Add( HRSL );
	HRSL->AddDetector( new THaVDC("vdc","Drift Chamber" ));
    HRSL->AddDetector( new THaScintillator("s0","s0 scintillator") );
    ...
    if(bPhysics){
      ...
      Double_t mass_tg = 39.948*amu; //default target 
